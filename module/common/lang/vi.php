...
$lang->qa->menu->testcase  = array('link' => 'Tình huống|testcase|browse|productID=%s', 'class' => 'dropdown dropdown-hover');
$lang->qa->menu->testtask  = array('link' => 'Yêu cầu|testtask|browse|productID=%s');
$lang->qa->menu->testsuite = array('link' => 'Suite|testsuite|browse|productID=%s');
$lang->qa->menu->report    = array('link' => 'Báo cáo|testreport|browse|productID=%s');
$lang->qa->menu->caselib   = array('link' => 'Thư viện tình huống|caselib|browse');
