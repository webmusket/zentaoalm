...
$lang->tutorial->tasks['createProject']         = array('title' => 'Tạo một ' . $lang->projectCommon);
$lang->tutorial->tasks['createProject']['nav']  = array('module' => 'project', 'method' => 'create', 'menu' => '#pageNav', 'form' => '#dataform', 'submit' => '#submit', 'target' => '.create-project-btn', 'targetPageName' => 'Tạo ' . $lang->projectCommon);
$lang->tutorial->tasks['createProject']['desc'] = "<p>Tạo một {$lang->projectCommon}: </p><ul><li data-target='nav'>Mở <span class='task-nav'> {$lang->projectCommon} <i class='icon icon-angle-right'></i> Tạo {$lang->projectCommon} </span>;</li><li data-target='form'>Điền form thông tin {$lang->projectCommon}</li><li data-target='submit'>Lưu lại</li></ul>";

$lang->tutorial->tasks['manageTeam']         = array('title' => "Quản lý thành viên {$lang->projectCommon}");
...
$lang->tutorial->tasks['manageTeam']['desc'] = "<p>Quản lý thành viên {$lang->projectCommon}: </p><ul><li data-target='nav'>Mở <span class='task-nav'> {$lang->projectCommon} <i class='icon icon-angle-right'></i> Đội nhóm <i class='icon icon-angle-right'></i> Quản lý thành viên nhóm</span> Page；</li><li data-target='form'>Chọn người dùng cho đội nhóm</li><li data-target='submit'>Lưu lại</li></ul>";
...
$lang->tutorial->tasks['linkStory']['desc'] = "<p>Liên kết một câu chuyện tới {$lang->projectCommon}: </p><ul><li data-target='nav'>Mở <span class='task-nav'> {$lang->projectCommon} <i class='icon icon-angle-right'></i> Câu chuyện <i class='icon icon-angle-right'></i>Liên kết câu chuyện</span></li><li data-target='form'>Chọn câu chuyện từ danh sách câu chuyện để liên kếtli><li data-target='submit'>Lưu lại</li></ul>";
...
$lang->tutorial->tasks['createTask']['desc'] = "<p>Chia nhỏ nhiệm vụ cho một câu chuyện: </p><ul><li data-target='nav'>Mở <span class='task-nav'> {$lang->projectCommon} <i class='icon icon-angle-right'></i> Câu chuyện <i class='icon icon-angle-right'></i> Chia nhỏ;</span></li><li data-target='form'>Điền form thông tin nhiệm vụ;</li><li data-target='submit'>Lưu lại</li></ul>";
